...
{{--                    <span class="menu-section text-muted text-uppercase fs-8 ls-1">داشبورد</span>--}}
{{--                </div>--}}
{{--            </div>--}}
            <div class="menu-item">
                <a class="menu-link {{request()->is('agent') ? 'active':''}}" href="{{route('agent.home')}}">
...
{{--            <div class="menu-item">--}}
{{--                <a class="menu-link {{request()->is('admin/customers') ? 'active':''}}" href="{{route('admin.mange.customers.index')}}">--}}
...
{{--            <div class="menu-item">--}}
{{--                <a class="menu-link {{request()->is('admin/agents') ? 'active':''}}" href="{{route('admin.mange.agent.index')}}">--}}

{{--                    <i class="kt-menu__link-icon  fa fa-user-secret">--}}
{{--                        &ensp;--}}
{{--                    </i>--}}
{{--                    <span class="menu-title"> إدارة المندوبين</span>--}}
{{--                </a>--}}
{{--            </div>--}}


{{--            <div class="menu-item">--}}
{{--                <a class="menu-link {{request()->is('admin/drivers') ? 'active':''}}" href="{{route('admin.mange.drivers.index')}}">--}}

{{--                    <i class="kt-menu__link-icon  fa fa-user-injured">--}}
{{--                        &ensp;--}}
{{--                    </i>--}}
...
{{--            </div>--}}
{{--            <div class="menu-item">--}}
{{--                <a class="menu-link {{request()->is('admin/vehicles') ? 'active':''}}" href="{{route('admin.mange.vehicles.index')}}">--}}

{{--                    <i class="kt-menu__link-icon  fa fa-bus-alt">--}}
{{--                        &ensp;--}}
{{--                    </i>--}}
{{--                    <span class="menu-title"> إدارة المركبات</span>--}}
{{--                </a>--}}
{{--            </div>--}}


            <div class="menu-item">
                <a class="menu-link {{request()->is('agent/trips') ? 'active':''}}" href="{{route('agent.mange.trip.index')}}">

                    <i class="kt-menu__link-icon  fa fa-bus">
                        &ensp;
                    </i>
            ...
            <div class="menu-item">
                <a class="menu-link {{request()->is('agent/company-trips') ? 'active':''}}" href="{{route('agent.mange.trip.others.index')}}">

                    <i class="kt-menu__link-icon  fa fa-bus">
                        &ensp;
                    </i>
                    <span class="menu-title">حجوزات الشركة</span>
                </a>
            </div>
            ...
            <div class="menu-item">
                ...
                <a class="menu-link " href="javascript::void(0)">
                    ...
                    <i class="kt-menu__link-icon  fa fa-facebook">
                        &ensp;
                    </i>

                    <div class="menu-title">082628196</div>
            ...
            <div class="menu-item">
                ...
                <a class="menu-link " href="javascript::void(0)">
                    ...
                    <div class="menu-title">00972598884045</div><br/>
            ...
            <div class="menu-item">
                ...
                <a class="menu-link " href="javascript::void(0)">
                    ...
                    <div class="menu-title">eng_ahmad_86@hotmail.com</div><br/>
            ...
            <div class="menu-item">
                ...
                <a class="menu-link " href="javascript::void(0)">
                    ...
                    <div class="menu-title">غزة - دوار الشاليهات - مبنى وكفي شوب آسيا - الطابق الثاني</div>
...
{{--            <div class="menu-item">--}}
{{--                <a class="menu-link {{request()->is('admin/reports') ? 'active':''}}" href="{{route('admin.report.index')}}">--}}

{{--                    <i class="kt-menu__link-icon  fa fa-file-excel">--}}
{{--                        &ensp;--}}
{{--                    </i>--}}
...
{{--            <div class="menu-item">--}}
{{--                <a class="menu-link {{request()->is('admin/mangers') ? 'active':''}}" href="{{route('admin.mange.admin.index')}}">--}}

{{--                    <i class="kt-menu__link-icon  fa fa-user-cog">--}}
{{--                        &ensp;--}}
{{--                    </i>--}}
{{--                    <span class="menu-title">مستخدمي الإدارة</span>--}}
{{--                </a>--}}
{{--            </div>--}}
