...
@section('content')
    ...
    <admins-list :fetch-data-url="'{{route('admin.mange.admin.search')}}'"
                 :role="'admin'"
                 inline-template>
        <div>
    ...
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">مستخدمين لوحة الإدارة</h3>
        ...
        <div class="card-body" style="overflow-x: scroll">
            ...
            >
                ...
                <table-column label="اسم المستخدم" :sortable="false" :filterable="false">
                    <template scope="user">
                ...
                <table-column label="الحالة ">
                    <template scope="user">
                        ...
                        <toggle-button
                            ...
                            color="#82C7EB"
                            :sync="true"
                            @change="onChangeEventToggleHandler($event,'{!! route('admin.mange.user.change.status') !!}',user.id)"
                        />
                        {{--                                        @endcan--}}
                    </template>
                </table-column>
...
{{--        </div>--}}
            ...
            <el-dialog
                ...
                width="40%"
                :title="id?'تعديل بيانات مستخدم':'إضافة مستخدم جديد'"
