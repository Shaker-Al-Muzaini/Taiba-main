...
{{--										</span>--}}
            ...
            <div class="menu-item">
                <a class="menu-link {{request()->is('admin/agents') ? 'active':''}}" href="{{route('admin.mange.agent.index')}}">
                    ...
                    <span class="menu-title"> مسؤولي المناطق </span>
                </a>
            </div>
            ...
            <div class="menu-item">
                <a class="menu-link {{request()->is('admin/drivers') ? 'active':''}}" href="{{route('admin.mange.drivers.index')}}">
                    ...
                    <i class="kt-menu__link-icon  fa fa-user-friends">
                        &ensp;
                    </i>
            ...
            <div class="menu-item">
                <a class="menu-link {{request()->is('admin/vehicles') ? 'active':''}}" href="{{route('admin.mange.vehicles.index')}}">
                    ...
                    <span class="menu-title"> بيانات الحافلات</span>
                </a>
            </div>

            <div class="menu-item">
                <a class="menu-link {{request()->is('admin/states') ? 'active':''}}" href="{{route('admin.mange.states.index')}}">

                    <i class="kt-menu__link-icon  fa fa-city">
                        &ensp;
                    </i>
                    <span class="menu-title">إدارة المناطق</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{request()->is('admin/trips') ? 'active':''}}" href="{{route('admin.mange.trip.index')}}">
