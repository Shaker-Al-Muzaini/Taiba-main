...
@endpush
@section('content')
    <trips-list :fetch-data-url="'{{route('admin.mange.trip.search')}}'"
                :role="'admin'"
                inline-template>
        <div class="card shadow-sm">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <a href="{{route('admin.mange.trip.create')}}" class="btn  btn-sm btn-primary">
            ...
            <div class="card-body" style="overflow-x: scroll">
                ...
                <table-component
                    :showFilter="false"
                    :data="fetchData"
                    :table-class="'table table-hover kt-datatable__table table-striped'"
                ...
                >
                    ...
                    <table-column label="الاجراءات" :sortable="false" :filterable="false">
                        <template scope="user">
                            ...
                            <a class="btn btn-sm btn-clean btn-icon btn-icon-md"
                               @click="deleteAction('/admin/trips/destroy/',user.id,true)" href="javascript:;">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <table v-if="trip.trip_type =='going' || trip.trip_type =='going_and_back'"
                            ...
                            <thead>
                            <tr>
                                <th><strong>بيانات الذهاب</strong> </th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                        ...
                        <table v-if="trip.trip_type =='back' || trip.trip_type =='going_and_back'" class="table  table-striped table-hover ">
                            <thead>
                            <tr>
                                <th><strong>بيانات العودة</strong> </th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
