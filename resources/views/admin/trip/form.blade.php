...
@endpush
@section('content')
    <trip-form :home-url="'{{route('admin.mange.trip.index')}}'"
               :trip="{{isset($trip)?$trip:0}}" inline-template>
            ...
            <div class="card-body">
                ...
                <form class="kt-form kt-form--label-right">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <span v-if="form.error && form.validations.customer_state"
                                          class="help-block invalid-feedback">
                              @{{ form.validations.customer_state[0] }}
                        </span>
                    ...
                    <div class="form-group row mb-3">
                        <label for="name1" class="col-sm-2 col-form-label">غرض الحجز</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row mb-3">
                        <label for="date" class="col-sm-2 col-form-label">تاريخ الحجز </label>
                        <div class="col-sm-10">
                            ...
                            <div class="fv-row">
                                ...
                                <div class="btn-group w-100" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                                    ...
                                    <label class="btn btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-success" :class="[payment_type=='bank'?'active':'']" data-kt-button="true">
                                        <!--begin::Input-->
                                        <input class="btn-check" type="radio" name="method" :checked="payment_type=='bank'?'checked':''"  value="bank" v-model="payment_type"/>
                                        <!--end::Input-->
                                        حوالة بنكية
                                    </label>
                                    <!--end::Radio-->
...
{{--                    </div>--}}
            ...
            <div class="card-footer">
               <button type="button" @click="storeTrip" class="btn   btn-primary">
                   <span v-if="!id"> إضافة حجز</span>
                   <span v-if="id"> تحديث حجز</span>
               </button>

                <a href="{{route('admin.mange.trip.index')}}" class="btn btn-secondary">
                    إلغاء الأمر
                </a>
            </div>
