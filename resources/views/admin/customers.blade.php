...
@section('content')
    ...
    <customers-list :fetch-data-url="'{{route('admin.mange.customers.search')}}'"
                 :role="'admin'"
                 inline-template>
        <div>
            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    <h3 class="card-title">إدارة الزبائن</h3>
                ...
                <div class="card-body" style="overflow-x: scroll">
                    ...
                    >
                        ...
                        <table-column label="اسم المنطقة" show="state_name"></table-column>
                        ...
                        <table-column label="الاجراءات" :sortable="false" :filterable="false">
                            ...
                            <a class="btn btn-sm btn-clean btn-icon btn-icon-md"
                               @click="deleteAction('/admin/customers/destroy/',user.id,true)" href="javascript:;">
            ...
            <el-dialog
                ...
                width="40%"
                :title="id?'تعديل بيانات الزبون':'إضافة زبون جديد'"
